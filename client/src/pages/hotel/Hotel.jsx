...
const Hotel = ({ user }) => {
  ...
  const startDate = dates && dates[0] && dates[0].startDate;
  const endDate = dates && dates[0] && dates[0].endDate;
  ...
  const days =
    startDate && endDate
      ? dayDifference(new Date(startDate), new Date(endDate))
      : 0;
  ...
  return (
    <React.Fragment>
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <span className="hotelPriceHighlight">
              Book a stay over in Rs. {data.cheapestPrice}/night at this
      ...
      {openModal && <Reserve setOpen={setOpenModal} hotelId={id} user={user} />}
    </React.Fragment>
  );
};
